---
name: routing
description: Stack decision table for routing work across kern, git-fs, vicky, Context7, pdf-reader, skills. Trigger when user says "follow stack routing", "route this", "which tool", or starts work in a stack-enabled project.
---
